...
var app = {
  ...
  init: function init() {
    var selectArea = createDiv("selectArea");
    selectArea.appendChild(this.divSelect); //this.divSelect.appendChild(createLoader());
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              this.store.countries = _context.sent;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 5:
              ...
              return _context2.abrupt("return", this.resultDiv.innerHTML = "Please refer to our pricing table for per minute rates");
...
function Button() {
  ...
  this.create = function (name, listener) {
    _this.button = document.createElement("input");
    _this.button.id = _this.id;
    _this.button.value = name;
    _this.button.type = "button";
    _this.button.onclick = listener;
...
function request(url, param) {
  return new Promise(function (resolve, reject) {
    ...
    var urlParams = param ? "".concat(url, "?").concat(Object.keys(param)[0], "=").concat(Object.values(param)[0]) : "".concat(url);
    xhr.open('GET', "".concat(urlParams));
    xhr.send();
  });
}
